...
<head>
    ...
    <link href="<%=cssPath%>/resources/easyui/themes/bootstrap/easyui.css" rel="stylesheet" type="text/css" />
    <link href="<%=cssPath%>/resources/easyui/themes/icon.css" rel="stylesheet" type="text/css" />
...
<center>
    <div class="easyui-layout" style="width:830px;height:560px; border: 1px rgb(202, 196, 196) solid;
        ...
        <div style="height: 100%;">
            <div class="easyui-tabs" data-options="fit:true,border:false">
                <div title="秒">
                    <div class="line">
                        <input type="radio" checked="checked" name="second" οnclick="everyTime(this)">
                        每秒 允许的通配符[, - * /]</div>
                    <div class="line">
                        <input type="radio" name="second" οnclick="cycle(this)">
                        周期从
                        ...
                        秒</div>
                    <div class="line">
                        <input type="radio" name="second" οnclick="startOn(this)">
                        从
                ...
                <div title="分钟">
                    <div class="line">
                        <input type="radio" checked="checked" name="min" οnclick="everyTime(this)">
                        分钟 允许的通配符[, - * /]</div>
                    <div class="line">
                        <input type="radio" name="min" οnclick="cycle(this)">
                        周期从
                        <input class="numberspinner" style="width: 60px;" data-options="min:1,max:58" value="1"
                               id="minStart_0">
                        -
                        ...
                        分钟</div>
                    <div class="line">
                        <input type="radio" name="min" οnclick="startOn(this)">
                        从
                        <input class="numberspinner" style="width: 60px;" data-options="min:0,max:59" value="0"
                               id="minStart_1">
                        分钟开始,每
                ...
                <div title="小时">
                    <div class="line">
                        <input type="radio" checked="checked" name="hour" οnclick="everyTime(this)">
                        小时 允许的通配符[, - * /]</div>
                    <div class="line">
                        <input type="radio" name="hour" οnclick="cycle(this)">
                        周期从
                        ...
                        小时</div>
                    <div class="line">
                        <input type="radio" name="hour" οnclick="startOn(this)">
                        从
                        <input class="numberspinner" style="width: 60px;" data-options="min:0,max:23" value="0"
                               id="hourStart_1">
                        小时开始,每
                ...
                <div title="日">
                    <div class="line">
                        <input type="radio" checked="checked" name="day" οnclick="everyTime(this)">
                        日 允许的通配符[, - * / L W]</div>
                    <div class="line">
                        <input type="radio" name="day" οnclick="unAppoint(this)">
                        不指定</div>
                    <div class="line">
                        <input type="radio" name="day" οnclick="cycle(this)">
                        周期从
                        ...
                        日</div>
                    <div class="line">
                        <input type="radio" name="day" οnclick="startOn(this)">
                        从
                        <input class="numberspinner" style="width: 60px;" data-options="min:1,max:31" value="1"
                               id="dayStart_1">
                        日开始,每
                        ...
                        天执行一次</div>
                    <div class="line">
                        <input type="radio" name="day" οnclick="workDay(this)">
                        每月
                        <input class="numberspinner" style="width: 60px;" data-options="min:1,max:31" value="1"
                               id="dayStart_2">
                        号最近的那个工作日</div>
                    <div class="line">
                        <input type="radio" name="day" οnclick="lastDay(this)">
                        本月最后一天</div>
                    <div class="line">
                ...
                <div title="月">
                    <div class="line">
                        <input type="radio" checked="checked" name="mouth" οnclick="everyTime(this)">
                        月 允许的通配符[, - * /]</div>
                    <div class="line">
                        <input type="radio" name="mouth" οnclick="unAppoint(this)">
                        不指定</div>
                    <div class="line">
                        <input type="radio" name="mouth" οnclick="cycle(this)">
                        周期从
                        ...
                        月</div>
                    <div class="line">
                        <input type="radio" name="mouth" οnclick="startOn(this)">
                        从
                        <input class="numberspinner" style="width: 60px;" data-options="min:1,max:12" value="1"
                               id="mouthStart_1">
                        日开始,每
                ...
                <div title="周">
                    <div class="line">
                        <input type="radio" checked="checked" name="week" οnclick="everyTime(this)">
                        周 允许的通配符[, - * / L #]</div>
                    <div class="line">
                        <input type="radio" name="week" οnclick="unAppoint(this)">
                        不指定</div>
                    <div class="line">
                        <input type="radio" name="week" οnclick="startOn(this)">
                        ...
                        <input class="numberspinner" style="width: 60px;" data-options="min:2,max:7" value="2"
                               id="weekEnd_0"></div>
                    <div class="line">
                        <input type="radio" name="week" οnclick="weekOfDay(this)">
                    ...
                    <div class="line">
                        <input type="radio" name="week" οnclick="lastWeek(this)">
                ...
                <div title="年">
                    <div class="line">
                        <input type="radio" checked="checked" name="year" οnclick="unAppoint(this)">
                        不指定 允许的通配符[, - * /] 非必填</div>
                    <div class="line">
                        <input type="radio" name="year" οnclick="everyTime(this)">
                        每年</div>
                    <div class="line">
                        <input type="radio" name="year" οnclick="cycle(this)">周期 从
            ...
            <fieldset style="border-radius: 3px; height: 220px;">
                ...
                <table style="height: 100px;">
                    ...
                    <tr>
                        ...
                        /></td>
                        <td><input type="button" value="反解析到UI " id="btnFan" οnclick="btnFan()"/></td>
                    </tr>
                    <tr >
    ...
    <div class="modal-footer">
        <input type="button" id="" οnclick="quxiao()" class="btn btn-default"
               value="取消" data-dismiss="modal" aria-hidden="true">
        <input type="button" id="" οnclick="addCron()" class="btn btn-info"
               value="确定" data-dismiss="modal" aria-hidden="true">
    </div>
</center>
<script src="<%=cssPath%>/resources/js/cron/jquery.min.js" type="text/javascript"></script>
<script src="<%=cssPath%>/resources/js/cron/jquery.easyui.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    function getDateList() {
        var crontab = $('#cron').val();
        var startTime = new Date();
        var num = 5;
        if (!crontab) {
            crontab.focus();
            showErrorBox("请输入crontab表达式！");
            return false;
        } else {
            //$('#showTable').show();
            //$('#showResult').empty();
            $.ajax({
                ...
                url : "${base}/task/analysis_cron",
                async : false,
                success : function(data) {
                    if (data.data) {
                        for (var i = 0; i < data.data.length; i++) {
                            var html = "<tr><td>第 " + (i + 1) + "次执行</td><td>" + data.data[i] + " </td></tr>";
                            $('#runTime').append(html);
                        }
                    }else{
                        $.messager.alert("提示",'cron表达式错误');
                        //var crontab = $('#cron').val("");
                    }
                }
            });
...
<script src="<%=cssPath%>/resources/js/cron/cron.js"></script>
</body>
</html>
